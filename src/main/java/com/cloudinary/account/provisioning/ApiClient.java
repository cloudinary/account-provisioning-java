...
import com.cloudinary.account.provisioning.auth.Authentication;
import com.cloudinary.account.provisioning.auth.HttpBasicAuth;
import com.cloudinary.account.provisioning.auth.HttpBearerAuth;
import com.cloudinary.account.provisioning.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.cloudinary.com/v1_1/provisioning/accounts/ACCOUNT_ID";
    ...
    private void init() {
        ...
        setUserAgent("CloudinaryProvisioningJava/0.0.3" + " (Java " + System.getProperty("java.version") + ")");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.cloudinary.com/v1_1/provisioning/accounts/ACCOUNT_ID
     ...
     * @return a {@link com.cloudinary.account.provisioning.ApiClient} object
     */
   ...
   public void setCloudinaryAccountUrl(String cloudinaryUrl) {
     ...
     * @throws com.cloudinary.account.provisioning.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.cloudinary.account.provisioning.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.cloudinary.account.provisioning.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.cloudinary.account.provisioning.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.cloudinary.account.provisioning.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.cloudinary.account.provisioning.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.cloudinary.account.provisioning.ApiException If fails to update the parameters
     */
     ...
     * @throws com.cloudinary.account.provisioning.ApiException If fail to serialize the request body object into a string
     */
