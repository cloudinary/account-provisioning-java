...
public class UserGroupsApi {
     ...
     * @param groupId The ID of the user group. (required)
     * @param extendedDetails Whether to only return extended (true) or basic information about the group (false).  **Default**: false.  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getUserGroupCall(String groupId, Boolean extendedDetails, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (extendedDetails != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("extended_details", extendedDetails));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUserGroupValidateBeforeCall(String groupId, Boolean extendedDetails, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getUserGroupCall(groupId, extendedDetails, _callback);
        return localVarCall;
     ...
     * @see <a href="https://cloudinary.com/documentation/provisioning_api#get_user_group">Get User Group Documentation</a>
     */
    public UserGroup getUserGroup(String groupId, Boolean extendedDetails) throws ApiException {
        ApiResponse<UserGroup> localVarResp = getUserGroupWithHttpInfo(groupId, extendedDetails);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://cloudinary.com/documentation/provisioning_api#get_user_group">Get User Group Documentation</a>
     */
    public ApiResponse<UserGroup> getUserGroupWithHttpInfo(String groupId, Boolean extendedDetails) throws ApiException {
        okhttp3.Call localVarCall = getUserGroupValidateBeforeCall(groupId, extendedDetails, null);
        Type localVarReturnType = new TypeToken<UserGroup>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     * @see <a href="https://cloudinary.com/documentation/provisioning_api#get_user_group">Get User Group Documentation</a>
     */
    public okhttp3.Call getUserGroupAsync(String groupId, Boolean extendedDetails, final ApiCallback<UserGroup> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserGroupValidateBeforeCall(groupId, extendedDetails, _callback);
        Type localVarReturnType = new TypeToken<UserGroup>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getUserGroupsCall(Boolean extendedDetails, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUserGroupsValidateBeforeCall(Boolean extendedDetails, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getUserGroupsCall(extendedDetails, _callback);
        return localVarCall;
     ...
     * @see <a href="https://cloudinary.com/documentation/provisioning_api#get_user_groups">Get User Groups Documentation</a>
     */
    public UserGroupsResponse getUserGroups(Boolean extendedDetails) throws ApiException {
        ApiResponse<UserGroupsResponse> localVarResp = getUserGroupsWithHttpInfo(extendedDetails);
        return localVarResp.getData();
    }
     ...
     * @see <a href="https://cloudinary.com/documentation/provisioning_api#get_user_groups">Get User Groups Documentation</a>
     */
    public ApiResponse<UserGroupsResponse> getUserGroupsWithHttpInfo(Boolean extendedDetails) throws ApiException {
        okhttp3.Call localVarCall = getUserGroupsValidateBeforeCall(extendedDetails, null);
     ...
     * @see <a href="https://cloudinary.com/documentation/provisioning_api#get_user_groups">Get User Groups Documentation</a>
     */
    public okhttp3.Call getUserGroupsAsync(Boolean extendedDetails, final ApiCallback<UserGroupsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUserGroupsValidateBeforeCall(extendedDetails, _callback);
        Type localVarReturnType = new TypeToken<UserGroupsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
