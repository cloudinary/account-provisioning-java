...
public class ApiAccessKey {
  ...
  **/
   ...
   * @return the ApiAccessKey instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to ApiAccessKey
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiAccessKey.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
