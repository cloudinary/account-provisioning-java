...
public class UserGroupsResponse {
  ...
  **/
   ...
   * @return the UserGroupsResponse instance itself
   */
  public UserGroupsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userGroups, userGroupsResponse.userGroups)&&
        Objects.equals(this.additionalProperties, userGroupsResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserGroupsResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserGroupsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserGroupsResponse>() {
           ...
           public UserGroupsResponse read(JsonReader in) throws IOException {
             ...
             UserGroupsResponse instance = thisAdapter.fromJsonTree(jsonObj);
